...
fn main() {
    let img = image::open(r"H:\中转待处理\工大街拍IMG_1661.JPG")
        .unwrap()
        .to_rgb8();
    ...
    let layer = Layer::new(
        ...
        LayerType::ModernTone {
            ...
            midtone_contrast: 10.0,
            shadow_hue: 210.0,
            shadow_sat: 15.0,
            highlight_hue: 30.0,
            highlight_sat: 10.0,
            sat_high_suppress: 8.0,
            warmth_shift: 5.0,
            fine_grain: 0.0,
        },
    );
    ...
    let layer = Layer::new(
        ...
        LayerType::SplitTone {
            enabled: true,
            highlight_hue: 30.0,
            highlight_saturation: 50.0,
            shadow_hue: 210.0,
            shadow_saturation: 50.0,
            balance: 0.0,
            strength: 80.0,
        },
    );
    ...
    pipeline
        .save(r"H:\中转待处理\t10_pipeline_color_curve.png")
        .ok();
    ...
    let layer = Layer::new(
        ...
        LayerType::ModernTone {
            ...
            strength: 150.0,
            shadow_lift: 40.0,
            highlight_compress: 40.0,
            midtone_contrast: 30.0,
            shadow_hue: 300.0,
            shadow_sat: 40.0,
            highlight_hue: 60.0,
            highlight_sat: 30.0,
            sat_high_suppress: 50.0,
            warmth_shift: 20.0,
            fine_grain: 0.0,
        },
    );
...
fn check(label: &str, out: &RgbImage, orig: &RgbImage, n: f64) {
    ...
    eprintln!(
        "[{}] {}x{} bad={:.3}% blue={:.2}% black={} white={} maxΔ={:.1}%",
