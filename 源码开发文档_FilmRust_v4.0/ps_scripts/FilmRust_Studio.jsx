// ============================================================
// FilmRust Studio — Photoshop 联动脚本 v4.1
...
function runExe(cmd) {
    ...
    batFile.writeln("start /min /wait \"\" " + cmd);
    batFile.close();
    app.system(batPath);
    $.sleep(300);
}
...
function main() {
    ...
    var w = new Window("dialog", "FilmRust Studio -- 胶片模拟 v4.1");
    ...
    strengthSlider.preferredSize.width = 250;
    ...
    grainSlider.preferredSize.width = 250;
